...
public class Recup1 {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 //analyser json avec jackson a partir d'un fichier et crer un objet java  
		  ...
		  FileWriter filewriter = new FileWriter("D:/archive/soutenance/Lucene/collection_reduite3/Col1.txt");
		  //("D:/Lucene/collection_reduite/ids9.txt")
					...
					while((line = reader.readLine())!=null){ //readline : lit une ligne et renvoie une chaine 
						...
						for(File file2 : f2.listFiles())
						{
							...
							String id_str= object.getId_str();
							 ...
							 if(id_str.equals(line)==false){
								// System.out.println("**************************************************************************");
								 
								 incremente++;
								 if(incremente > 500) {break;}
